...
let lastUpdated = "";
let bgImg; // FIX 1: Leave this empty so p5.js can assign the image object properly
...
function preload() {
  ...
  bgImg = loadImage('picture.jpg'); 
}

function setup() {
  // FIX 2: Removed the duplicate 1000x600 canvas line. 
  // This now scales perfectly to your image width and height.
...
function draw() {
  ...
  if (aquariumData) {
    ...
    if(ph >= 8) {
      ...
      // NOTE: If you resized your background, make sure 480 and 305 still fit!
